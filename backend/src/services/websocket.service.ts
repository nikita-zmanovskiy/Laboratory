...
export class WebSocketService {
    ...
    broadcastLog(classroomCode: string, logEntry: any) {
        ...
        console.log(`[WS] Broadcasting to ${this.clients.size} clients for classroom ${classroomCode}`)
        ...
        console.log(`[WS] Sent to ${sent} clients`)
    }
    ...
    broadcastClassroomExtended(classroomCode: string, newExpiresAt: Date): void {
        ...
        console.log(`ws - classroom ${classroomCode} extended, notified clients`)
    }
}